function convertText() {
    ...
    const romanizedResult = document.getElementById('romanizedResult');
    ...
    let convertedTextRomanized = '';

    // Function to perform global replacements using regular expression
    function replaceAll(input, find, replace) {
        return input.replace(new RegExp(find, 'g'), replace);
    }

    // Convert inputText to IPA and Hangul simultaneously
    ...
    convertedTextHangul = replaceAll(convertedTextHangul, "누와", "놔");
    convertedTextHangul = replaceAll(convertedTextHangul, "즈와", "좌");
    ...
    for (let char of convertedTextHangul) {
        if (char in romanizedTable) {
            convertedTextRomanized += romanizedTable[char];
        } else {
            convertedTextRomanized += char;
        }
    }

    ipaResult.value = convertedTextIPA;
    hangulResult.value = convertedTextHangul;
    romanizedResult.value = convertedTextRomanized;
